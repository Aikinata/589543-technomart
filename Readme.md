...
* Студент: [Наталья Дубровина](https://up.htmlacademy.ru/htmlcss/23/user/589543).
* Наставник: `Кексобот`.
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/589543-technomart) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
